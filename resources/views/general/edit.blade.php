...
<div class="form-group">
 ...
 <div class="col-md-4">                     
    <textarea class="form-control" rows="10"  id="Overview (max 200 words)" name="permanant"></textarea>
  </div>
...
<div class="form-group">
  ...
  <div class="col-md-4">                     
    <textarea class="form-control" rows="10"  id="Overview (max 200 words)" name="temporary"></textarea>
  </div>
...
<div class="form-group">
  ...
  <div class="input-group">
    ...
    <input id="Phone number " name="p_number " type="text" placeholder=" Phone number " class="form-control input-md">
...
<div class="othertop">
    <
     ...
     <input type="input" name="language" id="Languages Known-4"  placeholder=" Language">
    </div>
