...
<form class="form-horizontal" method="post" action="{{url('committees')}}" enctype="multipart/form-data">
  {{ csrf_field() }}

<!-- Form Name -->
<legend>Post For Committe</legend>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="file">Upload</label>  
  <div class="col-md-4">
 <div class="input-group">
       <div class="input-group-addon">
