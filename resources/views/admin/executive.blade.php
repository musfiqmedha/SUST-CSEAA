...
<form class="form-horizontal" method="post" action="{{url('executives')}}" enctype="multipart/form-data">
  {{ csrf_field() }}

<!-- Form Name -->
<legend>Executive Profile form requirement</legend>
...
<div class="form-group">
 ...
 <div class="input-group">
       ...
       <input id="Designation" name="designation" type="text" placeholder="Desination" class="form-control input-md">
      </div>
...
<div class="form-group">
  ...
  <div class="input-group">
     ...
     <i class="fa fa-birthday-cake"></i>
       ...
       <input id="Date Of Birth" name="date_of_birth" type="text" placeholder="Date Of Birth" class="form-control input-md">
      </div>
...
<div class="form-group">
  ...
  <div class="col-md-4"> 
    <label class="radio-inline" for="radios-0">
      <input type="radio" name="marital" id="radios-0" value="1" checked="checked">
      Married
    </label> 
    <label class="radio-inline" for="radios-1">
      <input type="radio" name="marital" id="radios-1" value="2">
      Unmarried
    </label>
  </div>
</div>
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="s_occupation (if any)">Secondary Occupation (if any)</label>  
  <div class="col-md-4">
  <div class="input-group">
       <div class="input-group-addon">
      <i class="fa fa-briefcase"></i>
     ...
     <input id="Secondary Occupation (if any)" name="s_occupation" type="text" placeholder="Secondary Occupation (if any)" class="form-control input-md">
      </div>
...
<div class="form-group">
  ...
  <div class="input-group">
    ...
    <input id="Phone number " name="s_number " type="text" placeholder=" Secondary Phone number " class="form-control input-md">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="a_time">Availability time</label>  
  <div class="col-md-4">
  <div class="input-group">
       <div class="input-group-addon">
    ...
    <input id="Availability time" name="a_time" type="text" placeholder="Availability time" class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="checkbox">
    <label for="Languages Known-0">
      <input type="checkbox" name="language" id="Languages Known-0" value="1">
      Nepali
    </label>
    </div>
  <div class="checkbox">
    <label for="Languages Known-1">
      <input type="checkbox" name="language" id="Languages Known-1" value="2">
      Newari
    </label>
    </div>
  <div class="checkbox">
    <label for="Languages Known-2">
      <input type="checkbox" name="language" id="Languages Known-2" value="3">
      English
    </label>
    </div>
  <div class="checkbox">
    <label for="Languages Known-3">
      <input type="checkbox" name="language" id="Languages Known-3" value="4">
      Hindi
    </label>
    </div>
...
<div class="othertop">
    <label for="Languages Known-4">
     ...
     <input type="input" name="language" id="Languages Known-4"  placeholder="Other Language">
    </div>
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="work">Working Experience (time period)</label>  
  <div class="col-md-4">
  <div class="input-group">
       <div class="input-group-addon">
     <i class="fa fa-clock-o"></i>
    ...
    <input id="Working Experience (time period)" name="work" type="text" placeholder="Enter time period " class="form-control input-md">
