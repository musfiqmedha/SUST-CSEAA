...
<nav class="navbar navbar-expand-lg navbar-dark default-color-dark fixed-top">
    <a class="navbar-brand" href="index.html">SCAA</a>
                    ...
                    <div class="row">
                        <div class="col-md-12 wow fadeIn">
                            <div class="text-center text-danger">
                                <h1 class="display-2 mb-2 wow fadeInDown" data-wow-delay="0.3s">SCAA GALARY</h1>
...
<div class="container">
  ...
  <div class="main">
      <div class="box">
      <img src="{{ asset('gal_img/' . $photo->filename) }}" />
        <div>
        </div>
      <a class="more" href="#name">{{$photo->details}}</a>
