                    ...
                    <div class="row">
                        <div class="col-md-12 wow fadeIn">
                            <div class="text-center text-danger">
                                <h1 class="display-2 mb-2 wow fadeInDown" data-wow-delay="0.3s">SCAA EVENT</h1>
...
<div class="container">
  ...
  <div class="main">
      <div class="box">
      <img src="{{ asset('event_img/' . $event->pic) }}" />
        <div>
        </div>
      <a class="more" href="#name">{{$event->des}}</a>
...
<footer class="bg-dark text-white">
    <div class="text-center py-2 lead">Copyright  <a href="" target="_blank"></a></p></div>
</footer>
