                    ...
                    <div class="row">
                        <div class="col-md-12 wow fadeIn">
                            <div class="text-center text-danger">
                                <h1 class="display-2 mb-2 wow fadeInDown" data-wow-delay="0.3s">SCAA NEWS</h1>
...
<div class="container">
  ...
  <div class="main">
      <div class="box">
      <img src="{{ asset('news_img/' . $news->photo) }}" />
        <div>
        </div>
      <a class="more" href="{{$news->descript}}" target="_blank">{{$news->descript}}</a>
