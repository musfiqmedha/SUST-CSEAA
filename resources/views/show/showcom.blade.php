                    ...
                    <div class="row">
                        <div class="col-md-12 wow fadeIn">
                            <div class="text-center text-danger">
                                <h1 class="display-2 mb-2 wow fadeInDown" data-wow-delay="0.3s">Committee</h1>
...
<div class="container-fluid">
 ...
 <div >
      <img width="50%" class="img-circular" src="{{ asset('com_img/' . $committee->file) }}">
      
      <div class="container">
        <h2>{{$committee->name}}</h2>
        <p class="title">{{$committee->designation}}</p>
      </div>
    </div>
